...
import { deleteEducation } from "../aboutActions/deleteEducation";
import { updateEducation } from "../aboutActions/updateEducation";
...
const EducationPage = async () => {
  ...
  return (
    <div id="education-form" className="flex flex-col gap-6">
      <div className="rounded-3xl border border-foreground/10 bg-secondary/30 p-6 sm:p-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-0.5 text-xs text-muted-foreground">
                {educationData.length} entr{educationData.length !== 1 ? "ies" : "y"} on the About page
              </p>
            </div>
          </div>
          <Link
            href="/admin/about/education/addEducation"
        ...
        {educationData.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-foreground/15 bg-background/30 px-6 py-12 text-center text-sm text-muted-foreground">
            No education listed yet — add your first role.
          </div>
        ) : (
